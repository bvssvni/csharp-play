...
namespace Play
{
	...
	public class TestGenerator
	{
		...
		{
			var gen = LinearGeneratorModule.Range (0, 5, 1);
			int i = gen.Reset ();
			Assert.True (i == 0);
			gen.Next (ref i);
			Assert.True (i == 1);
		...
		{
			var a = LinearGeneratorModule.Range (0, 2, 1);
			var b = LinearGeneratorModule.Range (2, 4, 1);
		...
		{
			var a = LinearGeneratorModule.Range (0, 10, 1);
			var b = LinearGeneratorModule.Range (2, 12, 2);
		...
		{
			var a = LinearGeneratorModule.Range (0, 10, 1);
			var b = LinearGeneratorModule.Range (2, 8, 1);
		...
		{
			var a = LinearGeneratorModule.Range (0, 10, 1);
			var b = LinearGeneratorModule.Range (2, 8, 2);
			int j = 1;
			b.Next (ref j);
			Console.WriteLine (j);
			Assert.True (j == 2);
